...
namespace wiqilogin {
    ...
    public partial class loginDataSet1 : global::System.Data.DataSet {
        ...
        public partial class LoginDataTable : global::System.Data.TypedTableBase<LoginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public LoginRow AddLoginRow(string Username, string Password, string Name) {
...
namespace wiqilogin.loginDataSet1TableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Login] ([Username], [Password], [Name]) VALUES (@Username, @Pa" +
                "ssword, @Name);\r\nSELECT Username, Password, Name FROM Login WHERE (Username = @U" +
                "sername)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Login] SET [Username] = @Username, [Password] = @Password, [Name] = @Name WHERE (([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Name] = @Original_Name));
SELECT Username, Password, Name FROM Login WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::wiqilogin.Properties.Settings.Default.loginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, Name FROM dbo.Login";
        ...
        public virtual int Update(string Username, string Password, string Name, string Original_Username, string Original_Password, string Original_Name) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Name, string Original_Username, string Original_Password, string Original_Name) {
            return this.Update(Original_Username, Password, Name, Original_Username, Original_Password, Original_Name);
        }
    }
